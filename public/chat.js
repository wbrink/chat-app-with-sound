...
// notification sounds
const divNotifications = document.querySelector(".notificationDiv");
const volumeOnIcon = document.querySelector("#notificationVolumeOn");
const volumeOffIcon = document.querySelector("#notificationVolumeOff");

// audio sources
const enterSound = document.querySelector("#enterSound");
const exitSound = document.querySelector("#exitSound");
const recvSound = document.querySelector("#recvSound");
const sendSound = document.querySelector("#sendSound");

// var to tell if the sound is turned off. it is by default
var soundOn = false;
...
divNotifications.addEventListener("click", e => {
  if (soundOn == false) {
    // then turn the volume on
